    ...
    public sealed class AICommandWindow : EditorWindow
    {
        ...
        static string WrapPrompt(string input)
          => "Write a Unity Editor script.\n" +
             " - It provides its functionality as a menu item placed \"AI\" > \"Do Task\".\n" +
        ...
        [MenuItem("Window/AI Create Script")]
        static void Init() => GetWindow<AICommandWindow>(true, "AI Create Script");

        void OnGUI()
        {
            if (OpenAIUtil.IsApiKeyOk)
            {
            ...
            {
                EditorGUILayout.HelpBox(OpenAIUtil.ApiKeyErrorText, MessageType.Error);
            }
        }
